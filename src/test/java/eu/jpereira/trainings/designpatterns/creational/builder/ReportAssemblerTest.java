...
import eu.jpereira.trainings.designpatterns.creational.builder.xml.XTMLBodyReportBuilder;
...
public class ReportAssemblerTest {
	...
	public void testAssembleJSONReportBody() {
		...
		ReportBodyBuilder builder = new JSONBodyReportBuilder();
	...
	public void testAssembleXMLReportBody() {
		ReportAssembler assembler = new ReportAssembler();
		ReportBodyBuilder builder = new XTMLBodyReportBuilder();
	...
	public void testAssembleHTMLReportBody() {
		ReportAssembler assembler = new ReportAssembler();
		ReportBodyBuilder builder = new HTMLBodyReportBuilder();
